...
class IntertestSetupTest(unittest.TestCase):
    ...
    def test_install(self):
        ...
        intertest_setup.install(self.config, self.run_params, tag="ut")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_deploy_stateless(self):
        ...
        intertest_setup.deploy(self.config, self.run_params, tag="ut")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_boot(self):
        ...
        intertest_setup.boot(self.config, self.run_params, tag="0")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_download(self):
        ...
        intertest_setup.download(self.config, self.run_params, tag="0")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_upload(self):
        ...
        intertest_setup.upload(self.config, self.run_params, tag="0")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_shutdown(self):
        ...
        intertest_setup.shutdown(self.config, self.run_params, tag="0")
        self.assertEqual(len(DummyTestRunning.asserted_tests), 0, "Some tests weren't run: %s" % DummyTestRunning.asserted_tests)
    ...
    def test_manual_state_manipulation(self):
        ...
        for state_action in ["check", "pop", "push", "get", "set", "unset"]:
            ...
            setup_func(self.config, self.run_params)
